...
for fed_id in fed_id_list:
        ...
        Census21 = pd.read_csv (r"/Users/zack/Documents/Python/Community Backgrounders/98-401-X2021010_eng_CSV/98-401-X2021010_English_CSV_data.csv",low_memory=False, encoding='latin-1')
...
#CHRIS TO-DO: 
#FIX POPULATION SECTION LAST SENTENCE
#RUN LEEDS-GRENVILLE TO SEE IF SENIOR NUMBER PROBLEM STILL THERE
#Industrial base ratio too (can just make it IN COMPARISON, not put the 3 cases)
